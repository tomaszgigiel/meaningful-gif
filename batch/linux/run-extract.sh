...
(cd $DIR_PROJECT; lein run ./src/test/resources/properties/meaningful-gif.extract.agif.1000.properties; cd -) #
...
#(cd $DIR_PROJECT; lein run ./src/test/resources/properties/meaningful-gif.extract.mov.1000.properties; cd -) #
...
(cd $DIR_PROJECT; lein run ./src/test/resources/properties/meaningful-gif.extract.series.1000.properties; cd -) #
